    ...
    *, *::before, *::after {{ box-sizing: border-box; margin: 0; padding: 0; }}
    ...
    .hero::before {{
      ...
      background: radial-gradient(ellipse 80% 60% at 50% 0%, rgba(99,102,241,0.35) 0%, transparent 70%),
                  radial-gradient(ellipse 50% 40% at 80% 100%, rgba(139,92,246,0.2) 0%, transparent 60%),
                  radial-gradient(ellipse 40% 40% at 20% 80%, rgba(236,72,153,0.15) 0%, transparent 60%);
      pointer-events: none;
    }}
    .hero-orb {{
      position: absolute;
    ...
    .orb-2 {{ width: 200px; height: 200px; background: #ec4899; bottom: -40px; right: 5%; animation-delay: -3s; }}
    .orb-3 {{ width: 150px; height: 150px; background: #8b5cf6; top: 30%; right: 20%; animation-delay: -5s; }}
    @keyframes float {{
...
<nav>
  <div class="nav-inner">
    <div class="nav-brand">
      <span class="nav-logo">IKIGAI</span>
